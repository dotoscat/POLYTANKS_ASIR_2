...
server_office = orudp.Mailbox()
server_office.bind(ADDRESS)
server_office.set_protocol(read_message)

conn_office = orudp.Mailbox()
conn_office.connect(ADDRESS)
sent = conn_office.send_message(message, 1)
